...
After deployment, connect your messaging platforms ([Slack](/platforms/slack/), [Discord](/platforms/discord/), [Teams](/platforms/teams/), [Google Chat](/platforms/google-chat/), [WhatsApp](/platforms/whatsapp/), [Telegram](/platforms/telegram/)) via the admin page or the connections API — no platform-specific env vars needed.
