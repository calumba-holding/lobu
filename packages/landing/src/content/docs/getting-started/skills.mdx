---
title: Skills
description: How Lobu skills work, where they live, and how Lobu and Owletto starter skills are installed separately.
---
...
## Separate Starter Skills

Lobu and Owletto are separate products, so their starter skills install separately too.

```bash
# Install the Lobu starter skill
npx @lobu/cli@latest skills add lobu

# Install the Owletto starter skill
npx owletto@latest skills add owletto

# Install the Owletto OpenClaw variant
